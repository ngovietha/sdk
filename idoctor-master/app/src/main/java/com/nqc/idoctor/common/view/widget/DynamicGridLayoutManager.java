/*
 * Created by NQC on 4/30/20 11:07 PM
 *  Copyright© 2020 NQC. All Rights Reserved.
 *  Last modified 4/30/20 11:07 PM
 *
 */

package com.nqc.idoctor.common.view.widget;
...
public class DynamicGridLayoutManager extends GridLayoutManager {
    ...
    public DynamicGridLayoutManager(@NonNull final Context context, final int columnWidth) {
